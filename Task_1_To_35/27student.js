...
// const ages = [19, 22, 19, 111, 24, 20, 25, 1000, 26, 24, 25, 24]; Custom sort is needed for these kinds of arrays
...
let median = ages[Math.round(ages.length/2)];       //Math.round prevents code breaking for odd length
let range = max-min;
...
console.log(`Difference between Maximum and Average age is ${Math.abs(max - average).toFixed(3)}`);
